          ...
          <div class="col-lg-12">
            <div class="row content-panel">
              ...
              <div class="col-md-4 profile-text">
                ...
                <p style="color:#48cfad;">E-mail Address : <?php echo $renter_email;?>
                <br>Phone Number : <?php echo $number;?></p>
                <p>Hello <?php echo $first_name?>, welcome to Lynk|Us where finding an apartment, connecting to roommate & leasing your house out is made easy. This account is a renter's account!</p>
                <br>
              ...
              <div class="col-md-4 centered">
                <div class="profile-pic">  
                  <p><img src="../img/signup_renter/<?php echo $renter_picture; ?>" class="img-circle"></p>
                        ...
                        <div class="col-lg-6" >
                            <div class="stp-pic" style="width: 100%; height: 400px;">
                              <div style="width: 100%; height: 50%">
                                <img style="float: left; width:50%; height:100%;" src="img/<?php echo $property_image; ?>" alt="images">
                                <img style="float: right; width:50%; height:100%;" src="img/<?php echo $property_image2; ?>" alt="images">
                              </div>
                              <div style="width: 100%; height: 50%">
                                <img style="float: left; width:50%; height:100%;" src="img/<?php echo $property_image3; ?>" alt="images">
                                <img style="float: right; width:50%; height:100%;" src="img/<?php echo $property_image4; ?>" alt="images">
                              </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
