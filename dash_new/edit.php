                ...
                <div class="col">
                    <div class="row">
                        <div class="col-sm-7 pl-0 pr-3">
                            ...
                            <!-- <p class="popup-text mb-4 text-white">Helping business overcome challenges with trustworthiness & over a decade of comprehensive experience.</p> -->
                            <form method="post" action="profile.php" class="form-subscribe form-inline position-relative" enctype="multipart/form-data" >
                                ...
                                <div class="form-group" style="margin-bottom: 20px;">
                                    <input type="email" name="email_address" value="<?php echo $owners_email;?>" style="width: 400px;" class="form-control text-light"/>
                                </div>
                                ...
                                <button name="submit" type="submit" style="font-size: 20px; border-radius: 10px; height: 40px; margin-top: 10px; width: 400px;">Done</button>
                            </form>
                        </div>
                        <div class="col-sm-5 px-0">
                            <!-- <div class="popup-image-inner">
                                <img class="position-absolute popup-image" src="./bites/images/i-phone-white.png" srcset="./bites/images/i-phone-white@2x.png 2x" alt="" />
                            </div> -->
                        </div>
                    </div>
                </div>       
