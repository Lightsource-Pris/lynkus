...
<head>
  ...
  <title>Admin</title>
    <link rel="shortcut icon" type="" href="../dash_new/img/linkus.ico">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a class="active" href="acceptedrents.php">
              <i class="fa fa-desktop"></i>
              <span>Accepted Requests</span>
              </a> 
          </li>
          <li class="sub-menu">
            <a class="" href="rejectedrents.php">
              <i class="fa fa-desktop"></i>
      ...
      <section class="wrapper site-min-height" >
        <div class="row mt" >
          <div class="col-lg-12">
            <!-- CHART PANELS -->
            <div class="row"  >
                <p style="text-align:center; font-size:30px"><b>ACCEPTED REQUESTS</b></p>

              <?php include "includes/db.php"; 


                  
                $query = "SELECT * FROM rent WHERE status ='accepted' ";
